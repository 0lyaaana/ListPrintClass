...
%>
<li>
<div class=times><%= lottoList.get(i).getTimes() %></div> &emsp;&emsp;&emsp;
<img src="images/lotto_img/ball_<%= lottoList.get(i).getNum1() %>.png"> &ensp;
<img src="images/lotto_img/ball_<%= lottoList.get(i).getNum2() %>.png"> &ensp;
<img src="images/lotto_img/ball_<%= lottoList.get(i).getNum3() %>.png"> &ensp;
<img src="images/lotto_img/ball_<%= lottoList.get(i).getNum4() %>.png"> &ensp;
<img src="images/lotto_img/ball_<%= lottoList.get(i).getNum5() %>.png"> &ensp;
<img src="images/lotto_img/ball_<%= lottoList.get(i).getNum6() %>.png"> &emsp;
<div class=bonus> &emsp; + &emsp; 보너스번호</div> &emsp; <img src="images/lotto_img/ball_<%= lottoList.get(i).getBonusNum() %>.png">
</li>
<% } %>
</ul>
